    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="first" name="grade1" type="text" value="">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="second" name="grade2" type="text" value="">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="third" name="grade3" type="text" value="">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="fourth" name="grade4" type="text" value="">
                </div>
            </div>
        </div>
