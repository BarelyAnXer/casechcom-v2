...
if (isset($_POST['UPDATE'])) {
    ...
    $sql = "update subject set name='$name', description ='$description' where subject_id='$id'";
    ...
    <div class="card card-outline card-primary">
        <div style="padding-top: 50px; padding-bottom: 50px;">
            <form align="center" action="" method="POST" novalidate>
                name: <input align="center" type="text" name="name" required value="<?php echo $subject['name'] ?>"><br><br>
                description: <input align="center" type="text" name="description"
                                    value="<?php echo $subject['description'] ?>" required>
                <br><br>
            ...
            if ($rows > 0) {
                foreach ($rows as $row) {
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="subject-edit.php?id=<?php echo $row['subject_id']; ?>"
                               class="btn btn-primary btn-flat ">
                                <i class="material-icons">edit_note</i>
                            </a>
                            <a href="subject-crd.php?id=<?php echo $row['subject_id']; ?>"
