                    ...
                    if ($rows > 0) {
                        foreach ($rows as $row) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['student_guardian_firstname'] . " " . $row['student_guardian_middlename'] . " " . $row['student_guardian_lastname']; ?></td>
                                <td><?php echo $row['student_guardian_relation']; ?></td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="registrar-student-delete.php?id=<?php echo $row['user_id']; ?>"
