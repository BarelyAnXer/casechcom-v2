			...
			<li  class="active">
		      ...
		      <div class="small-screen navbar-display">
                ...
                <li class="dropdown">
					...
					<i class="material-icons">group_add</i><span>Register</span></a>
                    <ul class="collapse list-unstyled menu" id="pageSubmenu2">
                        <li>
                            <a href="register-student.php">Admit Student</a>
                        </li>
                        <li>
				 ...
				 <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu3">
                        ...
                        <li>
                            <a href="#">Restore Attendance Reports</a>
                        </li>
				...
				<li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu5">
                        <li>
                            <a href="#">Manage Grades</a>
                        </li>
                        <li>
                            <a href="#">View Grades Records</a>
                        </li>
                        <li>
                            <a href="#">Restore Grades Reports</a>
                        </li>
                    </ul>
                </li>
			   ...
			   <li class="dropdown">
					...
					<i class="material-icons">payments</i><span>Finance</span></a>
                    <ul class="collapse list-unstyled menu" id="pageSubmenu6">
                         <li>
                            <a href="#">Manage School Fees</a>
                        </li>
                        <li>
                            <a href="#">View School Fees Records</a>
                        </li>
                        <li>
                            <a href="#">Restore School Fees Reports</a>
                        </li>
                    </ul>
                </li>
