        ...
        if ($rows > 0) {
            foreach ($rows as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="./teaches-view-one.php?id=<?php echo $row['teaches_id']; ?>">VIEW</a>
                        <a href="./teacher-edit.php?id=<?php echo $row['teaches_id']; ?>">EDIT</a>
                        <a href="./teacher-delete.php?id=<?php echo $row['teaches_id']; ?>">DELETE</a>
                    </td>
                </tr>
                <?php
            }
